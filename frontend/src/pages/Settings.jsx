			...
			<Box>
				<Box>
					<Typography variant='h4' sx={{ fontWeight: "bold" }}>
						Settings for <Link href={"/user/" + user._id}>@{user.name}</Link>
					</Typography>
				</Box>
				...
				<Box sx={{ maxWidth: "70%", marginLeft: "auto", marginBottom: 2 }}>
					<MySettingsItem>
						...
						<Box sx={{ marginBottom: 3 }}>
							<Typography variant='h6'>A post office</Typography>
							<TextField
								onChange={(event) =>
						...
						<Box sx={{ marginBottom: 3 }}>
							<Typography variant='h6'>Photo profile</Typography>
							<Box
								sx={{
									marginTop: 1,
									display: "flex",
					...
					<MySettingsItem>
						...
						<Box sx={{ marginBottom: 3 }}>
							...
							<TextField
								onChange={(event) =>
									setUser({ ...user, skills: event.target.value })
								}
								value={user.skills}
								variant='outlined'
								fullWidth
						...
						<Box sx={{ marginBottom: 3 }}>
							...
							<TextField
								onChange={(event) =>
									setUser({ ...user, work: event.target.value })
								}
								value={user.work}
								variant='outlined'
								fullWidth
					...
					<MySettingsItem>
						{message.text && (
							<Alert sx={{ marginBottom: 1 }} severity={message.type}>
								{message.text}
							</Alert>
						)}
						<Button
						...
						>
							Save information about the profile
						</Button>
					</MySettingsItem>
				</Box>
			</Box>
